...
*   [x] **TOPIK Exam Image & Audio Support (Mở rộng):**
    ...
    *   [x] Tối ưu hóa Local TTS bằng model `facebook/mms-tts-kor` kết hợp `torchaudio` pitch shift chuyên nghiệp, tránh méo tiếng và kiểm soát tốc độ chính xác, hỗ trợ giới hạn số câu khi sinh file nghe toàn bộ.
