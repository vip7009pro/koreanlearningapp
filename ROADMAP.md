...
*   [x] **TOPIK Exam Image & Audio Support (Mở rộng):**
    ...
    *   [x] Tích hợp giọng nữ thật tiếng Hàn chất lượng cao cho Local TTS bằng model `facebook/mms-tts-kss` (Meta) kết hợp `uroman` để thay thế giọng pitch-shifting ảo, hỗ trợ giới hạn số câu hỏi khi tạo file nghe toàn bộ.
