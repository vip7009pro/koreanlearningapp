...
*   [ ] **Phát triển Module Sổ tay Từ vựng Chuyên ngành (Professional Vocabulary Glossary):**
    *   [ ] Thiết kế giao diện chuyên mục học từ vựng riêng biệt, chia thành các thư mục: *Tiếng Hàn IT, Tiếng Hàn Văn phòng/Thương mại, Tiếng Hàn Sản xuất (Dệt may/Cơ khí), Tiếng Hàn Xây dựng*.
...
*   [ ] **Tối ưu hóa Hệ thống Quảng cáo & Thanh toán:**
    *   [ ] Thiết lập giới hạn tần suất hiển thị Interstitial Ads (Capped at 1 ad per 3 minutes) tránh gây ức chế cho người dùng miễn phí.
...
*   [ ] **Xây dựng hệ thống Khung sườn Viết TOPIK (TOPIK Writing Scaffold):**
    *   [ ] Thiết kế giao diện hỗ trợ viết **TOPIK II Câu 53 (Phân tích biểu đồ)**: Cung cấp danh sách các liên từ chỉ sự tăng/giảm, cấu trúc miêu tả phần trăm, nguyên nhân kết quả để người dùng bấm chọn và chèn nhanh vào bài viết.
    *   [ ] Hỗ trợ các mẫu lập luận chuẩn cho **Câu 54 (Nghị luận xã hội)** theo từng chủ đề (Môi trường, Giáo dục, Công nghệ...).
*   [ ] **Hệ thống Chẩn đoán Điểm yếu bằng AI (AI Gap Diagnostics & Study Rx):**
    *   [ ] Lưu lại lịch sử trả lời sai của người dùng trong các bài thi thử TOPIK hoặc Quizzes.
    *   [ ] Tạo một service AI phân tích các lỗi ngữ pháp thường gặp nhất (ví dụ: dùng sai trợ từ 은/는/이/가, nhầm lẫn cấu trúc -아/어서 và -(으)니까).
    *   [ ] Hiển thị biểu đồ thống kê trực quan về mức độ thành thạo các kỹ năng (Nghe, Đọc, Viết) và các dạng bài thi.
    *   [ ] Đưa ra **"Đơn thuốc học tập" (Study Prescription)**: tự động tạo playlist các bài học lý thuyết ngữ pháp/từ vựng có sẵn trên app để người dùng ôn lại ngay lập tức.
*   [ ] **Tích hợp Vé Chấm Điểm AI (AI Consumable Purchases):**
    *   [ ] Tạo model quản lý số dư "Vé chấm AI" trong database (`User.aiTicketsBalance`).
    *   [ ] Cập nhật API backend để kiểm tra và khấu trừ vé khi người dùng free thực hiện chấm bài viết AI.
    *   [ ] Cài đặt thanh toán gói vé chấm điểm qua cổng Google Play.

### Giai đoạn 3: Hội Thoại AI Tương Tác & Gói Doanh Nghiệp B2B (Tháng 4-6 - Giai đoạn Mở rộng & Doanh nghiệp)
*   [ ] **Hội thoại Tương tác AI (Interactive AI Dialogue Tutor & Speaking Practice):**
    *   [ ] Tích hợp tính năng nói/hội thoại nhập vai (Roleplay Scenarios) sử dụng AI. Ví dụ: *"Phỏng vấn xin việc với Giám đốc Hàn Quốc"*, *"Trao đổi công việc tại xưởng sản xuất"*.
    *   [ ] Áp dụng công nghệ Speech-to-Text để chuyển giọng nói tiếng Hàn của học viên thành văn bản.
    *   [ ] Sử dụng AI đánh giá độ chính xác của phát âm, ngữ điệu và gợi ý cách dùng từ tự nhiên hơn của người bản xứ (Shadowing Evaluator).
