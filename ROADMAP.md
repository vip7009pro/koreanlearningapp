...
*   [x] **Tích hợp Vé Chấm Điểm AI (AI Consumable Purchases):**
    ...
    *   [x] Tích hợp xem quảng cáo nhận vé miễn phí vào luồng hết lượt (dialog) tại Luyện viết AI và Hội thoại AI.
    *   [x] Tối ưu hóa UI/UX dialog Hết lượt chấm/dùng AI với cấu trúc xếp chồng dọc (vertical stack) các nút hành động, tránh co cụm/tràn chữ.
